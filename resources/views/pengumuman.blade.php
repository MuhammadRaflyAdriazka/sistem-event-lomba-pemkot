...
<body class="d-flex flex-column min-vh-100">
    ...
    <div class="flex-grow-1">
        <div class="container-fluid py-5">
            <div class="container">
                <!-- Tombol kembali di pojok kiri atas seperti status pendaftaran -->
                <div class="mb-4">
                ...
                <!-- Card Pengumuman dengan style seperti Status Pendaftaran -->
                        ...
                        @if($pengumumanList->count() > 0)
                            @foreach($pengumumanList as $pengumuman)
                                <div class="card border-0" style="box-shadow: 0 0 30px rgba(0, 0, 0, 0.1); margin-bottom: 30px;">
                                    <!-- Header biru seperti Status Pendaftaran -->
                                    ...
                                    <!-- Body dengan background putih polos -->
