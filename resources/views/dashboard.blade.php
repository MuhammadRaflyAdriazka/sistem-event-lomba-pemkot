                ...
                <div class="col-lg-6 mb-4 event-item event-card" 
                    ...
                    <div class="card shadow-lg border-0 rounded-lg overflow-hidden h-100">
                        ...
                        <div class="card-body p-4">
                            ...
                            <p>
                                <span class="badge {{ $acara->sistem_pendaftaran == 'Seleksi' ? 'badge-warning' : 'badge-info' }}">{{ $acara->sistem_pendaftaran }}</span>
                                <small class="text-muted ml-2">- Kuota: {{ number_format($acara->kuota) }} peserta</small>
                            </p>
                            ...
                            <div class="mt-3">
                                ...
                                @php
                                    $sudahDaftar = $pendaftaranUser->where('id_acara', $acara->id)->isNotEmpty();
                                @endphp
                                @if($sudahDaftar)
